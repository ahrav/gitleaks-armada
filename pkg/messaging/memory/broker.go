...
func (b *Broker) PublishTask(ctx context.Context, task messaging.Task) error {
...
func (b *Broker) PublishTasks(ctx context.Context, tasks []messaging.Task) error {
...
func (b *Broker) SubscribeTasks(ctx context.Context, handler func(messaging.Task) error) error {
	return subscribe(ctx, &b.mu, &b.taskHandlers, handler)
}

// PublishResult broadcasts a scan result to all subscribed handlers.
// The handlers are copied before iteration to prevent deadlocks and ensure consistency.
func (b *Broker) PublishResult(ctx context.Context, result messaging.ScanResult) error {
...
func (b *Broker) SubscribeResults(ctx context.Context, handler func(messaging.ScanResult) error) error {
...
// The handlers are copied before iteration to prevent deadlocks and ensure consistency.
func (b *Broker) PublishProgress(ctx context.Context, progress messaging.ScanProgress) error {
...
func (b *Broker) SubscribeProgress(ctx context.Context, handler func(messaging.ScanProgress) error) error {
