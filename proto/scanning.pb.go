...
var file_proto_scanning_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_scanning_proto_goTypes = []interface{}{
	...
	nil,                         // 8: scanner.Checkpoint.MetadataEntry
...
var file_proto_scanning_proto_depIdxs = []int32{
	...
	9, // 2: scanner.Finding.raw_finding:type_name -> google.protobuf.Struct
	6, // 3: scanner.TaskProgressedEvent.checkpoint:type_name -> scanner.Checkpoint
	8, // 4: scanner.Checkpoint.metadata:type_name -> scanner.Checkpoint.MetadataEntry
