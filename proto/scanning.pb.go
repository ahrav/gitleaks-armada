...
type TaskResumeEvent struct {
	...
	JobId       string      `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`
	TaskId      string      `protobuf:"bytes,2,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	SourceType  string      `protobuf:"bytes,3,opt,name=source_type,json=sourceType,proto3" json:"source_type,omitempty"` // TODO: maybe use enum?
...
func (x *TaskResumeEvent) GetSourceType() string {
	if x != nil {
		return x.SourceType
	}
	return ""
...
var file_proto_scanning_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xfb, 0x01, 0x0a, 0x0f, 0x54, 0x61, 0x73, 0x6b,
	...
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2a, 0xa4, 0x01, 0x0a, 0x0d, 0x53, 0x63, 0x61, 0x6e, 0x4a, 0x6f,
	...
	0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75,
