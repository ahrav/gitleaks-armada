...
var file_proto_scanning_proto_rawDesc = []byte{
	...
	0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_proto_scanning_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_proto_scanning_proto_goTypes = []interface{}{
	...
	nil,                         // 10: scanner.Checkpoint.MetadataEntry
...
var file_proto_scanning_proto_depIdxs = []int32{
	...
	11, // 2: scanner.Finding.raw_finding:type_name -> google.protobuf.Struct
	6,  // 3: scanner.TaskProgressedEvent.checkpoint:type_name -> scanner.Checkpoint
	10, // 4: scanner.Checkpoint.metadata:type_name -> scanner.Checkpoint.MetadataEntry
