...
type TaskStartedEvent struct {
	...
	ScannerId   string `protobuf:"bytes,5,opt,name=scanner_id,json=scannerId,proto3" json:"scanner_id,omitempty"`       // ID of the scanner assigned to this task (optional)
}
...
func (x *TaskStartedEvent) GetScannerId() string {
	if x != nil {
		return x.ScannerId
	}
	return ""
...
type ScannerRegisteredEvent struct {
	...
	ScannerId     string            `protobuf:"bytes,1,opt,name=scanner_id,json=scannerId,proto3" json:"scanner_id,omitempty"`                                                              // Unique identifier for the scanner instance
	ScannerName   string            `protobuf:"bytes,2,opt,name=scanner_name,json=scannerName,proto3" json:"scanner_name,omitempty"`                                                        // Unique name of the scanner instance
	Version       string            `protobuf:"bytes,3,opt,name=version,proto3" json:"version,omitempty"`                                                                                   // Scanner software version
	Capabilities  []string          `protobuf:"bytes,4,rep,name=capabilities,proto3" json:"capabilities,omitempty"`                                                                         // What types of scanning this instance can perform
	GroupName     string            `protobuf:"bytes,5,opt,name=group_name,json=groupName,proto3" json:"group_name,omitempty"`                                                              // Optional: if not provided, assigned to default group
	Hostname      string            `protobuf:"bytes,6,opt,name=hostname,proto3" json:"hostname,omitempty"`                                                                                 // Host where scanner is running
	IpAddress     string            `protobuf:"bytes,7,opt,name=ip_address,json=ipAddress,proto3" json:"ip_address,omitempty"`                                                              // Network address of the scanner
	Timestamp     int64             `protobuf:"varint,8,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                                                                              // When registration occurred (Unix timestamp in nanoseconds)
	Tags          map[string]string `protobuf:"bytes,9,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Labels for filtering and grouping scanners
	InitialStatus ScannerStatus     `protobuf:"varint,10,opt,name=initial_status,json=initialStatus,proto3,enum=scanner.ScannerStatus" json:"initial_status,omitempty"`                     // Initial status of the scanner
}
...
func (x *ScannerRegisteredEvent) GetScannerId() string {
	if x != nil {
		return x.ScannerId
	}
	return ""
...
type ScannerHeartbeatEvent struct {
	...
	ScannerId   string             `protobuf:"bytes,1,opt,name=scanner_id,json=scannerId,proto3" json:"scanner_id,omitempty"`                                                                      // Unique identifier for the scanner instance
	ScannerName string             `protobuf:"bytes,2,opt,name=scanner_name,json=scannerName,proto3" json:"scanner_name,omitempty"`                                                                // Unique name of the scanner instance
	Status      ScannerStatus      `protobuf:"varint,3,opt,name=status,proto3,enum=scanner.ScannerStatus" json:"status,omitempty"`                                                                 // Current operational status
	Timestamp   int64              `protobuf:"varint,4,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                                                                                      // When heartbeat was sent (Unix timestamp in nanoseconds)
	Metrics     map[string]float64 `protobuf:"bytes,5,rep,name=metrics,proto3" json:"metrics,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"` // Optional metrics about scanner health/performance
}
...
func (x *ScannerHeartbeatEvent) GetScannerId() string {
	if x != nil {
		return x.ScannerId
	}
	return ""
...
type ScannerStatusChangedEvent struct {
	...
	ScannerId      string        `protobuf:"bytes,1,opt,name=scanner_id,json=scannerId,proto3" json:"scanner_id,omitempty"`                                            // Unique identifier for the scanner instance
	ScannerName    string        `protobuf:"bytes,2,opt,name=scanner_name,json=scannerName,proto3" json:"scanner_name,omitempty"`                                      // Unique name of the scanner instance
	NewStatus      ScannerStatus `protobuf:"varint,3,opt,name=new_status,json=newStatus,proto3,enum=scanner.ScannerStatus" json:"new_status,omitempty"`                // New operational status
	PreviousStatus ScannerStatus `protobuf:"varint,4,opt,name=previous_status,json=previousStatus,proto3,enum=scanner.ScannerStatus" json:"previous_status,omitempty"` // Status before this change
	Reason         string        `protobuf:"bytes,5,opt,name=reason,proto3" json:"reason,omitempty"`                                                                   // Explanation for the status change
	Timestamp      int64         `protobuf:"varint,6,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                                                            // When status changed (Unix timestamp in nanoseconds)
}
...
func (x *ScannerStatusChangedEvent) GetScannerId() string {
	if x != nil {
		return x.ScannerId
	}
	return ""
...
type ScannerDeregisteredEvent struct {
	...
	ScannerId   string `protobuf:"bytes,1,opt,name=scanner_id,json=scannerId,proto3" json:"scanner_id,omitempty"`       // Unique identifier for the scanner instance
	ScannerName string `protobuf:"bytes,2,opt,name=scanner_name,json=scannerName,proto3" json:"scanner_name,omitempty"` // Unique name of the scanner instance
	Reason      string `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`                              // Why the scanner is being deregistered
	Timestamp   int64  `protobuf:"varint,4,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                       // When deregistration occurred (Unix timestamp in nanoseconds)
}
...
func (x *ScannerDeregisteredEvent) GetScannerId() string {
	if x != nil {
		return x.ScannerId
	}
	return ""
...
var file_proto_scanning_proto_rawDesc = []byte{
	...
	0xa2, 0x01, 0x0a, 0x10, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64, 0x45,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x63, 0x61, 0x6e, 0x6e,
	0x65, 0x72, 0x49, 0x64, 0x22, 0xca, 0x02, 0x0a, 0x13, 0x54, 0x61, 0x73, 0x6b, 0x50, 0x72, 0x6f,
	0x67, 0x72, 0x65, 0x73, 0x73, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x17, 0x0a, 0x07,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c,
	0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0b, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x4e, 0x75, 0x6d, 0x12,
	...
	,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x62, 0x0a, 0x12, 0x54, 0x61, 0x73, 0x6b, 0x43, 0x6f,
	0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x0a, 0x06,
	0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6a, 0x6f,
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x77, 0x0a, 0x0f, 0x54, 0x61,
	0x73, 0x6b, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x0a,
	0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6a,
	...
	0x73, 0x6f, 0x6e, 0x22, 0x4b, 0x0a, 0x12, 0x54, 0x61, 0x73, 0x6b, 0x48, 0x65, 0x61, 0x72, 0x74,
	0x62, 0x65, 0x61, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x61, 0x73,
	...
	,
	...
	0x6e, 0x74, 0x12, 0x20, 0x0a, 0x04, 0x61, 0x75, 0x74, 0x68, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0c, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x52, 0x04,
	0x61, 0x75, 0x74, 0x68, 0x22, 0x8f, 0x01, 0x0a, 0x12, 0x54, 0x61, 0x73, 0x6b, 0x4a, 0x6f, 0x62,
	0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x6a,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x73, 0x63,
	0x61, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xbc, 0x01, 0x0a, 0x0f, 0x54, 0x61, 0x73, 0x6b, 0x50,
	0x61, 0x75, 0x73, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x6a, 0x6f,
	...
	,
	...
	0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x67,
	0x72, 0x6f, 0x75, 0x70, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x68, 0x6f,
	...
	0x61, 0x6d, 0x70, 0x12, 0x3d, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x29, 0x2e, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x53, 0x63, 0x61, 0x6e,
	0x6e, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x2e, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x04, 0x74, 0x61,
	0x67, 0x73, 0x12, 0x3d, 0x0a, 0x0e, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x73, 0x63, 0x61,
	0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x53, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74,
	...
	,
	...
	0x74, 0x61, 0x6d, 0x70, 0x12, 0x45, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x2e,
	0x53, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x45, 0x6e, 0x74,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8b, 0x02, 0x0a, 0x19, 0x53, 0x63, 0x61, 0x6e,
	0x6e, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x63, 0x61, 0x6e, 0x6e,
	0x65, 0x72, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x63, 0x61, 0x6e,
	0x6e, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x35, 0x0a, 0x0a, 0x6e, 0x65, 0x77, 0x5f, 0x73,
	...
	0x74, 0x75, 0x73, 0x52, 0x09, 0x6e, 0x65, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x3f,
	0x0a, 0x0f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65,
	0x72, 0x2e, 0x53, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x92, 0x01, 0x0a, 0x18, 0x53, 0x63, 0x61, 0x6e, 0x6e, 0x65,
	0x72, 0x44, 0x65, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x49,
	0x64, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72,
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x03,
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2a, 0xbd, 0x02, 0x0a, 0x0d, 0x53,
	0x63, 0x61, 0x6e, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1f, 0x0a, 0x1b,
	...
	,
	...
	,
