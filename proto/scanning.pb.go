...
var file_proto_scanning_proto_rawDesc = []byte{
	...
	0x22, 0xb0, 0x01, 0x0a, 0x0f, 0x4a, 0x6f, 0x62, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x45,
	...
	,
...
var file_proto_scanning_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_scanning_proto_goTypes = []interface{}{
	...
	(*JobCreatedEvent)(nil),     // 4: scanner.JobCreatedEvent
	(*TaskStartedEvent)(nil),    // 5: scanner.TaskStartedEvent
	(*TaskProgressedEvent)(nil), // 6: scanner.TaskProgressedEvent
	(*Checkpoint)(nil),          // 7: scanner.Checkpoint
	(*TaskCompletedEvent)(nil),  // 8: scanner.TaskCompletedEvent
	(*TaskFailedEvent)(nil),     // 9: scanner.TaskFailedEvent
	(*TaskHeartbeatEvent)(nil),  // 10: scanner.TaskHeartbeatEvent
	(*TaskResumeEvent)(nil),     // 11: scanner.TaskResumeEvent
	(*TaskJobMetricEvent)(nil),  // 12: scanner.TaskJobMetricEvent
	nil,                         // 13: scanner.Checkpoint.MetadataEntry
	(*structpb.Struct)(nil),     // 14: google.protobuf.Struct
	(*TargetSpec)(nil),          // 15: shared.TargetSpec
	(*AuthConfig)(nil),          // 16: shared.AuthConfig
	(SourceType)(0),             // 17: shared.SourceType
}
var file_proto_scanning_proto_depIdxs = []int32{
	...
	14, // 2: scanner.Finding.raw_finding:type_name -> google.protobuf.Struct
	15, // 3: scanner.JobCreatedEvent.target_spec:type_name -> shared.TargetSpec
	16, // 4: scanner.JobCreatedEvent.auth_config:type_name -> shared.AuthConfig
	7,  // 5: scanner.TaskProgressedEvent.checkpoint:type_name -> scanner.Checkpoint
	13, // 6: scanner.Checkpoint.metadata:type_name -> scanner.Checkpoint.MetadataEntry
	17, // 7: scanner.TaskResumeEvent.source_type:type_name -> shared.SourceType
	7,  // 8: scanner.TaskResumeEvent.checkpoint:type_name -> scanner.Checkpoint
	1,  // 9: scanner.TaskJobMetricEvent.status:type_name -> scanner.TaskStatus
